...
<html lang="en">
    ...
    <body>
                ...
                <div class="team-details-wrapper">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="team-image bg-cover" style="background-image: url('assets/img/team/details.jpg');"></div>
                        </div>
                        <div class="col-lg-5 mt-5 mt-lg-0 wow fadeInUp" data-wow-delay=".5s">
                            <div class="team-details-content">
                                ...
                                <a href="contact.blade.php" class="theme-btn style-line-height mt-5">contact with me</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="team-skill fix section-padding bg-cover" style="background-image: url('assets/img/banner/main-cta-bg-2.jpg');">
            <div class="container">
        ...
        <div class="marque-section section-padding pt-0">
            <div class="marquee-wrapper mt-0 text-slider style-responsive">
                <div class="marquee-inner to-left">
                    <ul class="marqee-list d-flex">
                        <li class="marquee-item">
                            ...
                            <span class="text-slider"><img src="assets/img/star-2.svg" alt="icon-img"></span> <span class="text-slider"></span> <span class="text-slider text-color">delicious</span>
                            <span class="text-slider text-color">food</span> <img src="assets/img/star-2.svg" alt="icon-img"> <span class="text-slider"></span> <span class="text-slider text-color">populer</span>
                            <span class="text-slider text-color">dishes</span> <span class="text-slider"></span><span class="text-slider"><img src="assets/img/star-2.svg" alt="icon-img"></span> <span class="text-slider"></span> <span class="text-slider text-color">delicious</span>
                            <span class="text-slider text-color">populer</span><span class="text-slider"></span> <span class="text-slider text-color">dishes</span>
                            <span class="text-slider"><img src="assets/img/star-2.svg" alt="icon-img"></span> <span class="text-slider"></span> <span class="text-slider text-color">delicious</span>
                            <span class="text-slider text-color">food</span> <img src="assets/img/star-2.svg" alt="icon-img"> <span class="text-slider"></span> <span class="text-slider text-color">populer</span>
                            <span class="text-slider text-color">dishes</span> <span class="text-slider"></span><span class="text-slider"><img src="assets/img/star-2.svg" alt="icon-img"></span> <span class="text-slider"></span> <span class="text-slider text-color">delicious</span>
        ...
        <section class="food-banner-section-3 fix">
            <div class="container">
                <div class="row g-4">
