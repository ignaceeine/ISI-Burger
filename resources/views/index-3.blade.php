                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-product-items-2 text-center">
                            <div class="product-content">
                                <h4>
                                    <a href="shop-single.blade.php">single fresh burger</a>
                                </h4>
                                <div class="star">
                            ...
                            <div class="product-image">
                                ...
                                <ul class="product-icon d-flex justify-content-center align-items-center">
                                    ...
                                    <li>
                                        <a href="shop-cart.blade.php" class="theme-btn cart-btn">
                                        <i class="far fa-shopping-cart"></i>
                                        Add to Cart
                                        </a>
                                    </li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="single-product-items-2 text-center">
                            <div class="product-content">
                                <h4>
                                    <a href="shop-single.blade.php">pizza with mushrooms</a>
                                </h4>
                                <div class="star">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="single-product-items-2 text-center">
                            <div class="product-content">
                                <h4>
                                    <a href="shop-single.blade.php">double burger & fries</a>
                                </h4>
                                <div class="star">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                        <div class="single-product-items-2 text-center">
                            <div class="product-content">
                                <h4>
                                    <a href="shop-single.blade.php">fried chicken french</a>
                                </h4>
                                <div class="star">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                        <div class="single-product-items-2 text-center">
                            <div class="product-content">
                                <h4>
                                    <a href="shop-single.blade.php">pizza with creamy sauce</a>
                                </h4>
                                <div class="star">
                                    <i class="fas fa-star"></i>
                                    <i class="fas fa-star"></i>
            ...
            <div class="food-catagory-wrapper">
                <div class="catagory-product-card-3 center wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <div class="food-content">
                        ...
                        <a href="shop-single.blade.php" class="link-btn color-red">
