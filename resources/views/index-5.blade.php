                        ...
                        <div class="header-main">
                            ...
                            <div class="header-right d-flex justify-content-end align-items-center">
                                ...
                                <div class="header-button">
                                    <a href="shop-single.blade.php" class="theme-btn bg-transparent">
                                ...
                                <div class="hero-content">
                                    <h5 data-animation="fadeInUp" data-delay="1.3s">FAST FOOD BURGERS</h5>
                                        ...
                                        <div class="hero-button">
                                            <a href="food-menu.blade.php" class="theme-btn fadeInUp animated" data-animation="fadeInUp" data-delay="1.9s">
                                                <span class="button-content-wrapper d-flex align-items-center">
                                                <span class="button-icon"><i class="flaticon-delivery"></i></span>
                                                <span class="button-text">Our Menu</span>
                                                </span>
                                            </a>
                                            <a href="shop-single.blade.php" class="theme-btn bg-red-2 fadeInUp animated" data-animation="fadeInUp" data-delay="1.9s">
                                                <span class="button-content-wrapper d-flex align-items-center">
                                                <span class="button-icon"><i class="flaticon-delivery"></i></span>
                                                <span class="button-text">order now</span>
                                                </span>
                    ...
                    <div class="col-lg-6">
                        <div class="product-outer-items">
                            <div class="product-image">
                                <a href="shop-single-2.blade.php">
                            ...
                            <div class="product-content">
                                ...
                                <a href="shop-single-2.blade.php" class="product-btn"><i class="far fa-check-circle"></i> Select Options</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="catagory-product-card-3 style-burger">
                            ...
                            <div class="catagory-content">
                                <h4><a href="shop-single.blade.php">Shrimp Burger</a></h4>
                                <p>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                    <div class="product-outer-items style-2">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <a href="shop-single-2.blade.php" class="product-btn"><i class="far fa-check-circle"></i> Add Too Cart</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="food-banner-items-2 bg-effect bg-cover" style="background-image: url(assets/img/home-5/burger/01.jpg);">
                        ...
                        <div class="food-content">
                            ...
                            <a href="shop-single.blade.php" class="theme-btn bg-red mt-4">
                            <span class="button-content-wrapper d-flex align-items-center">
                            <span class="button-icon"><i class="flaticon-delivery"></i></span>
                            <span class="button-text">order now</span>
                            </span>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="food-banner-items-2 bg-effect bg-cover" style="background-image: url(assets/img/home-5/burger/02.jpg);">
                        ...
                        <div class="food-content">
                            ...
                            <a href="shop-single.blade.php" class="theme-btn bg-yellow border-radius-none mt-4">
                            <span class="button-content-wrapper d-flex align-items-center">
                            <span class="button-icon"><i class="flaticon-delivery"></i></span>
                            <span class="button-text">order now</span>
                            </span>
