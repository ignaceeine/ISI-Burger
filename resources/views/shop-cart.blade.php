                        ...
                        <div class="col-12">
                            <div class="cart-wrapper">
                                        ...
                                        <tbody>
                                            <tr class="cart-item">
                                                <td class="cart-item-info">
                                                    <img src="{{ asset('img/shop-food/s1.png') }}" alt="Image">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="cart-item-quantity">
                                                        ...
                                                        <div class="cart-item-quantity-controller">
                                                            <a href="#" class="cart-increment">
                                                            <i class="far fa-caret-up"></i>
                                                            </a>
                                                            <a href="#" class="cart-decrement">
                                ...
                                <div class="cart-wrapper-footer">
                                    ...
                                    <a href="" class="theme-btn border-radius-none">
                                    Update Cart
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6">
                            <div class="cart-pragh-box">
                                <div class="cart-graph">
                                    ...
                                    <div class="chck">
                                        <a href="checkout.blade.php" class="theme-btn border-radius-none">
                                        Checkout
                                        </a>
                                    </div>
                                </div>
