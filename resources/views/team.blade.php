...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-team-items">
                            ...
                            <div class="team-content">
                                <p>head chef</p>
                                <h3>
                                    <a href="team-details.blade.php">Leslie Alexander</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="single-team-items active">
                            ...
                            <div class="team-content">
                                ...
                                <h3>
                                    <a href="team-details.blade.php">HENRY LUCAS</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="single-team-items">
                            ...
                            <div class="team-content">
                                <p>senoir cooker</p>
                                <h3>
                                    <a href="team-details.blade.php">MATEO LEVI</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-team-items">
                            ...
                            <div class="team-content">
                                <p>senoir cooker</p>
                                <h3>
                                    <a href="team-details.blade.php">Daniel Jack</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="single-team-items">
                            ...
                            <div class="team-content">
                                <p>senoir cooker</p>
                                <h3>
                                    <a href="team-details.blade.php">Owen Asher</a>
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="single-team-items">
                            ...
                            <div class="team-content">
                                <p>senoir cooker</p>
                                <h3>
                                    <a href="team-details.blade.php">Leslie Michael</a>
                                </h3>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Video Section Start -->
        <div class="video-section-2 style-2 fix bg-cover" style="background-image: url('assets/img/bg-image/bg-shape.png');">
            <div class="container">
                <div class="video-wrapper bg-cover" style="background-image: url('assets/img/banner/video-bg-3.jpg');">
        ...
        <section class="choose-us-2 fix section-padding bg-cover theme-bg" style="background-image: url('assets/img/bg-image/bg-shape.png');">
            <div class="container">
                ...
                <div class="booking-wrapper">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-5 mt-5 mt-lg-0 wow fadeInUp" data-wow-delay=".4s">
                            <div class="booking-contact style-2 bg-cover" style="background-image: url('assets/img/shape/booking-shape.png');">
