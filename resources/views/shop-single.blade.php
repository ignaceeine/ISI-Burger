                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="product-image-items">
                                <div class="tab-content" id="nav-tab-Content">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="product-image">
                                            ...
                                            <a href="assets/img/shop-food/details-1.png" class="icon img-popup">
                                ...
                                <div class="nav nav-tabs wow" id="nav-tab" role="tablist">
                                    ...
                                    <img src="assets/img/shop-food/s1.png" alt="img" class="image-tab">
                                    </button>
                                    <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                                    <img src="assets/img/shop-food/s2.png" alt="img" class="image-tab">
                                    </button>
                                    <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">
                                    <img src="assets/img/shop-food/s3.png" alt="img" class="image-tab">
                                    </button>
                                    ...
                                    <img src="assets/img/shop-food/s4.png" alt="img" class="image-tab">
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7 mt-5 mt-lg-0">
                            <div class="product-details-content">
                                ...
                                <h6 class="shop-text">GROUND DELIVERY SURCHARGE: <span>$180.00</span></h6>
                                <h6 class="details-info"><span>SKU:</span> <a href="shop-single.html">N/A</a></h6>
                                <h6 class="details-info"><span>Categories:</span> <a href="shop-single.html">Pizza</a></h6>
                                <h6 class="details-info"><span>Tags:</span> <a href="shop-single.html">Burgers, Tacos</a></h6>
                            </div>
                        </div>
                    </div>
