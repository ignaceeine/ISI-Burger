                                    ...
                                    <div class="col-xl-5 col-lg-7">
                                        <div class="hero-content">
                                            ...
                                            <div class="hero-button">
                                                <a href="shop-single.blade.php" class="theme-btn" data-animation="fadeInUp" data-delay="0.9s">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="catagory-product-card-2 text-center">
                            ...
                            <div class="catagory-product-content">
                                ...
                                <h4>
                                    <a href="shop-single.blade.php">ruti with beef slice</a>
                                </h4>
                                <div class="star">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="catagory-product-card-2 text-center">
                            ...
                            <div class="catagory-product-content">
                                ...
                                <h4>
                                    <a href="shop-single.blade.php">fast food combo</a>
                                </h4>
                                <div class="star">
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                        ...
                        <div class="col-xl-6 col-lg-6 mt-5 mt-lg-0">
                            <div class="about-content">
                                ...
                                <div class="info-area d-flex align-items-center">
                                    <a href="about.blade.php" class="theme-btn wow style-line-height fadeInUp" data-wow-delay=".3s">more about us</a>
                    ...
                    <div class="col-xl-7 col-lg-9 wow fadeInUp" data-wow-delay=".3s">
                        <div class="burger-banner-items bg-cover" style="background-image: url(assets/img/banner/burger-bg.png);">
                            <div class="burger-content text-center">
                                <h3>today</h3>
                                <h2>special</h2>
                                <h4><a href="shop.blade.php" class="text-white">beef <span>burger</span></a></h4>
                                <a href="shop-single.blade.php" class="theme-btn mt-4">
                                <span class="button-content-wrapper d-flex align-items-center">
                                <span class="button-icon"><i class="flaticon-delivery"></i></span>
                                <span class="button-text">order now</span>
                                </span>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-6">
                            <div class="kfc-content text-center">
                                ...
                                <a href="shop-single.blade.php" class="theme-btn mt-5 wow fadeInUp" data-wow-delay=".8s">
                                <span class="button-content-wrapper d-flex align-items-center">
                                <span class="button-icon"><i class="flaticon-delivery"></i></span>
                                <span class="button-text">order now</span>
                                </span>
        ...
        <section class="main-cta-banner section-padding pt-0">
            <div class="container">
                <div class="main-cta-banner-wrapper bg-cover mt-10" style="background-image: url('assets/img/banner/main-cta-bg.jpg');">
                    ...
                    <a href="shop-single.blade.php" class="theme-btn bg-white mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                    <span class="button-content-wrapper d-flex align-items-center">
                    <span class="button-icon"><i class="flaticon-delivery"></i></span>
                    <span class="button-text">order now</span>
                    </span>
                        ...
                        <div class="col-lg-5 mt-5 mt-lg-0 wow fadeInUp" data-wow-delay=".4s">
                            <div class="booking-contact bg-cover" style="background-image: url('assets/img/shape/booking-shape.png');">
                                ...
                                <div class="booking-items">
                                    ...
                                    <div class="form-clt">
                                        <a href="reservation.blade.php" class="theme-btn bg-yellow">
                                        booking now
                                        </a>
                                    </div>
                                </div>
