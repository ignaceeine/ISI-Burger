                            ...
                            <div class="blog-posts">
                                <div class="single-blog-post">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h2><a href="news-details.blade.php">QUICK CRAVINGS: UNRAVELING FAST FOOD DELIGHTS</a></h2>
                                        <p>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-4">
                                            <div class="post-link">
                                                <a href="news-details.blade.php"><i class="fas fa-arrow-right"></i> Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-blog-post">
                                    <div class="post-featured-thumb bg-cover" style="background-image: url('assets/img/news/post-2.jpg');"></div>
                                    <div class="post-content">
                                        <div class="post-meta">
                                ...
                                <div class="single-blog-post">
                                    <div class="post-featured-thumb bg-cover" style="background-image: url('assets/img/news/post-3.jpg');"></div>
                                    <div class="post-content">
                                        <div class="post-meta">
                                            <span><i class="fal fa-user"></i>Shikhon .Ha</span>
                                            <span><i class="fal fa-comments"></i>35 Comments</span>
                            ...
                            <div class="main-sidebar">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="popular-posts">
                                        <div class="single-post-item">
                                            ...
                                            <div class="post-content">
                                                <h5><a href="news-details.blade.php">Budget Issues Force The Our To Become</a></h5>
                                                <div class="post-date">
                                        ...
                                        <div class="single-post-item">
                                            ...
                                            <div class="post-content">
                                                <h5><a href="news-details.blade.php">The Best Products That Shape Fashion</a></h5>
                                                <div class="post-date">
                                        ...
                                        <div class="single-post-item">
                                            <div class="thumb bg-cover" style="background-image: url('assets/img/news/pp3.jpg');"></div>
                                            <div class="post-content">
                                                <h5><a href="news-details.blade.php">The Best Products That Shape Fashion</a></h5>
                                                <div class="post-date">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="widget_categories">
                                        <ul>
                                            <li><a href="news.html"><i class="flaticon-burger"></i>burger <span>23</span></a></li>
                                            <li><a href="news.html"><i class="flaticon-chicken"></i>Fried Chiken <span>24</span></a></li>
                                            <li><a href="news.html"><i class="flaticon-french-fries"></i>French Fries <span>11</span></a></li>
                                            <li><a href="news.html"><i class="flaticon-pizza"></i>Hot Pizzas <span>05</span></a></li>
                                            <li><a href="news.html"><i class="flaticon-sandwich"></i>Sandwich <span>06</span></a></li>
                                            <li><a href="news.html"><i class="flaticon-bread"></i>Bread <span>10</span></a></li>
                                            <li><a href="news.html"><i class="flaticon-rice"></i>fried rice <span>13</span></a></li>
                                            <li><a href="news.html"><i class="flaticon-hotdog"></i>hot dog <span>07</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="single-sidebar-widget">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="tagcloud">
                                        ...
                                        <a href="news-details.blade.php">hot dog</a>
                                        <a href="news-details.blade.php">french fry</a>
                                        <a href="news-details.blade.php">chiken</a>
                                        <a href="news-details.blade.php">pasta</a>
                                        <a href="news-details.blade.php">Sandwich</a>
                                        <a href="news-details.blade.php">landing</a>
                                        <a href="news-details.blade.php">fast food</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="main-cta-banner-2 section-padding bg-cover" style="background-image: url('assets/img/banner/main-cta-bg-2.jpg');">
            ...
            <div class="container">
                <div class="main-cta-banner-wrapper-2 d-flex align-items-center justify-content-between">
                    ...
                    <a href="shop-single.blade.php" class="theme-btn bg-white">
