            ...
            <div class="container-fluid">
                <div class="mega-menu-wrapper">
                    <div class="header-main">
                        <div class="logo-left">
                            <a href="index.blade.php" class="logo-1">
                                <img src="assets/img/logo/logo-2.svg" alt="logo-img">
                            </a>
                            <a href="index.blade.php" class="logo-2">
                                <img src="assets/img/logo/logo.svg" alt="logo-img">
                            </a>
                        </div>
                                ...
                                <div class="col-xl-3 col-lg-5">
                                    <div class="hero-content">
                                        ...
                                        <div class="hero-button">
                                            <a href="shop-single.blade.php" class="theme-btn bg-yellow border-radius-none" data-animation="fadeInUp" data-delay="1s">
        ...
        <section class="catagory-pizza-product-section fix section-padding">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div class="catagory-product-card-3">
                            ...
                            <div class="catagory-content">
                                <h4><a href="shop-single.blade.php">Shrimp pizza</a></h4>
                                <div class="star">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="catagory-product-card-3">
                            ...
                            <div class="catagory-content">
                                <h4><a href="shop-single.blade.php">Seafood pizza</a></h4>
                                <div class="star">
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div class="catagory-product-card-3">
                            ...
                            <div class="catagory-content">
                                <h4><a href="shop-single.blade.php">Cheese pizza</a></h4>
                                <div class="star">
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                        <div class="catagory-product-card-3">
                            ...
                            <div class="catagory-content">
                                <h4><a href="shop-single.blade.php">Glute-Free Pizza</a></h4>
                                <div class="star">
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                ...
                <div class="shop-button text-center mt-5 wow fadeInUp" data-wow-delay=".4s">
                    <a href="shop.blade.php" class="theme-btn">
                        <span class="button-content-wrapper d-flex align-items-center">
                        <span class="button-icon"><i class="flaticon-delivery"></i></span>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="about-content">
                                ...
                                <a href="about.blade.php" class="theme-btn wow fadeInUp" data-wow-delay=".5s">Read More</a>
                            </div>
                        </div>
                ...
                <div class="fooder-menu-wrapper">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="food-menu-items d-flex align-items-center justify-content-between">
                                <div class="food-menu-content">
                                    <h4><a href="shop-single.blade.php">BUFFALO CHICKEN PIZZA</a></h4>
                                    <p>
                        ...
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                            <div class="food-menu-items d-flex align-items-center justify-content-between">
                                <div class="food-menu-content">
                                    <h4><a href="shop-single.blade.php">CHICKEN ALFREDO PIZZA</a></h4>
                                    <p>
                                        It's the perfect dining experience where Experience quick and efficient
                                    </p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="food-menu-items active d-flex align-items-center justify-content-between">
                                <div class="food-menu-content">
                                    <h4><a href="shop-single.blade.php">SMOKED SAUSAGE PIZZA</a></h4>
                                    <p>
                                        It's the perfect dining experience where Experience quick and efficient
                                    </p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                            <div class="food-menu-items d-flex align-items-center justify-content-between">
                                <div class="food-menu-content">
                                    <h4><a href="shop-single.blade.php">CLASSIC PEPPERONI PIZZA</a></h4>
                                    <p>
                                        It's the perfect dining experience where Experience quick and efficient
                                    </p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="food-menu-items d-flex align-items-center justify-content-between">
                                <div class="food-menu-content">
                                    <h4><a href="shop-single.blade.php">CALIFORNIA STYLE PIZZA</a></h4>
                                    <p>
                                        It's the perfect dining experience where Experience quick and efficient
                                    </p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                            <div class="food-menu-items d-flex align-items-center justify-content-between">
                                <div class="food-menu-content">
                                    <h4><a href="shop-single.blade.php">HAWAIIAN PINEAPPLE PIZZA</a></h4>
                                    <p>
                                        It's the perfect dining experience where Experience quick and efficient
                                    </p>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="food-menu-items d-flex align-items-center justify-content-between">
                                <div class="food-menu-content">
                                    <h4><a href="shop-single.blade.php">Chicago Deep Pizza.</a></h4>
                                    <p>
                                        It's the perfect dining experience where Experience quick and efficient
                                    </p>
                                </div>
                    ...
                    <div class="col-xl-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="news-box-items">
                            ...
                            <div class="news-content">
                                ...
                                <h4>
                                    <a href="news-details.blade.php">How to keep fear from ruining your art business with confident</a>
                                </h4>
                                <p>
                                    It's the perfect dining experience where every dish is crafted with fresh, high-quality
                                ...
                                <a href="news-details.blade.php" class="link-btn mt-3">Read More <i class="fas fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="news-area-2">
                            <div class="news-box-items-2 wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="news-content">
                                    ...
                                    <h4><a href="news-details.blade.php">How to keep fear from ruining your art business with confident</a></h4>
                                    <p>Corporate businesses typically offerings <br> services such as man or consultin</p>
                                    <a href="news-details.blade.php" class="link-btn color-2 mt-3">Read More <i class="fas fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="news-box-items-2 wow fadeInUp" data-wow-delay=".5s">
                                ...
                                <div class="news-content">
                                    ...
                                    <h4><a href="news-details.blade.php">The Ultimate Guide to Crafting the Perfect Homemade Pizza Dough</a></h4>
                                    <p>Corporate businesses typically offerings <br> services such as man or consultin</p>
                                    <a href="news-details.blade.php" class="link-btn color-2 mt-3">Read More <i class="fas fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="news-box-items-2 wow fadeInUp" data-wow-delay=".7s">
                                ...
                                <div class="news-content">
                                    ...
                                    <h4><a href="news-details.blade.php">PIZZA NIGHT: HOW TO HOST A FUN AND DELICIOUS PIZZA PARTY</a></h4>
                                    <p>Corporate businesses typically offerings <br> services such as man or consultin</p>
                                    <a href="news-details.blade.php" class="link-btn color-2 mt-3">Read More <i class="fas fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="footer-bottom-wrapper d-flex align-items-center justify-content-between">
                        <p class="wow fadeInLeft" data-wow-delay=".3s">
                            © Copyright <span class="theme-color-3">2024</span> <a href="index.blade.php">Foodking </a>. All Rights Reserved.
                        </p>
