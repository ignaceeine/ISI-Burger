                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="woocommerce-notices-wrapper">
                            <div class="product-showing">
                                <h5><a href="shop-right-sidebar.html"><span><img src="assets/img/filter.png" alt="img"></span> Filtering</a></h5>
                                <h5>Showing <span>1–12</span> of 27 results</h5>
                            </div>
                            <div class="form-clt">
                                <h6>Sort by: <a href="shop.blade.php"><i class="fal fa-sort-alt"></i></a></h6>
                        ...
                        <div class="row">
                                ...
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-content">
                                        <div class="catagory-button">
                                            <a href="shop-cart.blade.php" class="theme-btn-2"><i class="far fa-shopping-basket"></i>Add To Cart</a>
                                        </div>
                                        ...
                                        <h4>
                                            <a href="shop-single.blade.php">Chiness pasta</a>
                                        </h4>
                                        <div class="star">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style active text-center">
                                    ...
                                    <div class="catagory-product-content">
                                        ...
                                        <h4>
                                            <a href="shop-single.blade.php">Whopper Burger King</a>
                                        </h4>
                                        <div class="star">
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-content">
                                        ...
                                        <h4>
                                            <a href="shop-single.blade.php">delicious burger</a>
                                        </h4>
                                        <div class="star">
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-content">
                                        ...
                                        <h4>
                                            <a href="shop-single.blade.php">ruti with chiken</a>
                                        </h4>
                                        <div class="star">
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-content">
                                        ...
                                        <h4>
                                            <a href="shop-single.blade.php">grilled chiken</a>
                                        </h4>
                                        <div class="star">
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-image">
                                        <img src="assets/img/food/main-food-3.png" alt="product-img">
                                    </div>
                                    <div class="catagory-product-content">
                                        <div class="catagory-button">
                                            <a href="shop-cart.blade.php" class="theme-btn-2"><i class="far fa-shopping-basket"></i>Add To Cart</a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-image">
                                        <img src="assets/img/food/french-fry-3.png" alt="product-img">
                                    </div>
                                    <div class="catagory-product-content">
                                        <div class="catagory-button">
                                            <a href="shop-cart.blade.php" class="theme-btn-2"><i class="far fa-shopping-basket"></i>Add To Cart</a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-image">
                                        <img src="assets/img/food/fried-chicken-2.png" alt="product-img">
                                    </div>
                                    <div class="catagory-product-content">
                                        <div class="catagory-button">
                                            <a href="shop-cart.blade.php" class="theme-btn-2"><i class="far fa-shopping-basket"></i>Add To Cart</a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="catagory-product-card-2 shadow-style text-center">
                                    ...
                                    <div class="catagory-product-image">
                                        <img src="assets/img/food/french-fry-4.png" alt="product-img">
                                    </div>
                                    <div class="catagory-product-content">
                                        <div class="catagory-button">
                                            <a href="shop-cart.blade.php" class="theme-btn-2"><i class="far fa-shopping-basket"></i>Add To Cart</a>
                        ...
                        <div class="main-sidebar style-2">
                            <div class="single-sidebar-widget">
                                ...
                                <div class="widget-categories">
                                    <ul>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-burger"></i>burger</a></li>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-chicken"></i>Fried Chiken</a></li>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-french-fries"></i>French Fries</a></li>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-pizza"></i>Hot Pizzas</a></li>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-sandwich"></i>Sandwich</a></li>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-bread"></i>Bread</a></li>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-rice"></i>fried rice</a></li>
                                        <li><a href="shop-single.blade.php"><i class="flaticon-hotdog"></i>hot dog</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="single-sidebar-widget">
                                ...
                                <div class="range__barcustom">
                                    ...
                                    <div class="range-items">
                                        <div class="price-input d-flex">
                                            ...
                                            <a href="shop-left-sidebar.blade.php" class="theme-btn border-radius-none">Filter</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="popular-food-posts">
                                    <div class="single-post-item">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h4><a href="shop-single.blade.php">ruti with chiken</a></h4>
